...
package frc.robot.commands.Auto.AutoDirectives.BR;
...
public class BR_ToSpeaker extends SequentialCommandGroup {
  /** Creates a new MildAuto. */
  public BR_ToSpeaker(SwerveSubsystem s_sSwerve) {
