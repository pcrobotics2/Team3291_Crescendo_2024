...
public class OldWayLeftTestDeleteLater extends SequentialCommandGroup {
  /** Creates a new MildAuto. */
  public OldWayLeftTestDeleteLater(SwerveSubsystem s_sSwerve) {
    ...
    Trajectory exampleTrajectory =
        TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(0, 3, new Rotation2d(40)),
            config);
