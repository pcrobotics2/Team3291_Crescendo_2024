...
public class RL_MildAuto extends SequentialCommandGroup {
  ...
  public RL_MildAuto(SwerveSubsystem swerveSubsystem, LauncherSub launcherSub, IntakeMotorSubsystem intakeMotorSubsystem, VisionSubsystem visionSubsystem, PreferencesSubsystem preferencesSubsystem) {
